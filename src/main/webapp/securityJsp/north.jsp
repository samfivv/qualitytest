...
<script type="text/javascript" charset="utf-8">
	...
	var logoutFun = function() {
		$.post(sy.contextPath + '/mdmy/operatorController/loginOut', function(result) {
	 ...
	 data-options="menu:'#layout_north_pfMenu',iconCls:'ext-icon-rainbow'">更换皮肤</a>
	  ...
	  data-options="menu:'#layout_north_kzmbMenu',iconCls:'ext-icon-cog'">控制面板</a>
	   <a href="javascript:void(0);" class="easyui-linkbutton" 
	    data-options="iconCls:'ext-icon-door_out'" onclick="logoutFun();">退出系统</a>
</div>
...
<div id="layout_north_zxMenu" style="width: 100px; display: none;">
	<div style="display: none;" data-options="iconCls:'ext-icon-lock'" onclick="lockWindowFun();">锁定窗口</div>
	<div class="menu-sep"></div>
</div>