...
<script type="text/javascript">
	...
	var editFun = function(id,userId) {
					 var dialog = parent.sy.modalDialog({
							title : '特长人审核',
							url : sy.contextPath + '/securityJsp/application/applicationForm.jsp?applicationId=' + id+'&userId='+userId,
							buttons : [ {
								text : '审核',
								handler : function() {
	...
	$(function() {
		grid = $('#grid').datagrid({
			title : '',
			url : '<%=contextPath%>/mdmy/userApplication/findByConditions',
			striped : true,
			rownumbers : true,
			pagination : true,
			singleSelect : true,
			sortName : 'applicationCreateTime',
			sortOrder : 'desc',
			pageSize : 50,
