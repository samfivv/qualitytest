...
<body>
	<form method="post" class="form" id="operatorForm">
		<input name="operatorId" value="<%=id%>" type="hidden" />
		...
		<fieldset>
			...
			<table class="table" style="width: 100%;">
				<tr>
					<th >登录名</th>
					<td><input name="operatorName" class="easyui-validatebox" data-options="required:true"/></td>
					<th>状态</th>
					<td><select name="operatorState" class="easyui-combobox easyui-validatebox"  
						data-options="panelHeight:'auto',editable:false,required:true" id="operatorState" >
				...
				<tr>
					...
					<th>手机</th>
					<td><input name="operatorMobile" ></td>
				<tr>
					<th>职位</th>
