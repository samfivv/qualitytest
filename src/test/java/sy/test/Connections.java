...
String url = "jdbc:mysql://192.168.0.232:3306/md_myw?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull"; 
String user = "root"; 
String pass = "midai"; 
...
public static void main(String[] args) throws Exception{ 
	String pagekage="com/midai/miya/sys";
	String tableName="myw_permission";
...
public static ResultSet selectInformation(String tableName) throws SQLException{
	Connection conn=getConnection(); 
	String sql="SELECT column_name as columnName, COLUMN_KEY as columnKey ,column_comment as columnComment FROM Information_schema. COLUMNS WHERE table_Name = '"+tableName+"' and table_schema='md_myw'";
 ...
 * 2015年6月23日
 */
public static void createFile(String pagekagePathStr,String tableName,String suffix,String importStr,boolean flag) throws Exception{
 ...
 * 2015年6月24日
 */
public static void createServiceImpl(String pagekagePathStr,String tableName,boolean flag) throws Exception{
	String javaName=getFileName(tableName);
	String pagekageStr=pagekagePathStr.replace("/", ".");//首行引入包名
	importStr="";
	importStr+="import java.util.List;\r\nimport org.springframework.beans.factory.annotation.Autowired;\r\n"
			+"import org.springframework.stereotype.Service;\r\n"
			+"import "+pagekageStr+".dao."+javaName+"Dao;\r\nimport "+pagekageStr+".service."+javaName+"Service;\r\n"
			+"import "+pagekageStr+".model."+javaName+";\r\nimport com.midai.miya.utils.PageUtil;\r\n\n";
...
public static String createImplContent(String javaName){
	...
	String javaNameStr=javaName.replaceFirst(javaName.substring(0, 1), javaName.substring(0, 1).toLowerCase());
	str.append("@Service\r\n");
	str.append("public class "+ javaName+"ServiceImpl implements "+javaName+"Service {\r\n\n"
		        +"     @Autowired\r\n"
		        +"     private "+javaName+"Dao "+javaNameStr+"Dao;\r\n\n"
		        +"     @Override\r\n"
				+"     public List<"+javaName+"> findByConditions("+javaName+" "+javaNameStr+","+"PageUtil page) {\r\n"
				+"        List<"+javaName+"> lists="+javaNameStr+"Dao.findByConditions("+javaNameStr+",page);\r\n"
				+"        return lists;\r\n"
				+"     }\r\n\n"
				+"     @Override\r\n"
				+"     public long findByConditionsCount("+javaName+" "+javaNameStr+") {\r\n"
				+"        long count="+javaNameStr+"Dao.findByConditionsCount("+javaNameStr+");\r\n"
				+"        return count;\r\n"
				+"     }\r\n\n"
				+"     @Override\r\n"
				+"     public void save("+javaName+" "+javaNameStr+") {\r\n"
				+"        "+javaNameStr+"Dao.save("+javaNameStr+");\r\n"
				+"     }\r\n\n"
				+"     @Override\r\n"
				+"     public void update("+javaName+" "+javaNameStr+") {\r\n"
				+"        "+javaNameStr+"Dao.update("+javaNameStr+");\r\n"
				+"     }\r\n\n"
				+"     @Override\r\n"
				+"     public void delete("+javaName+" "+javaNameStr+") {\r\n"
				+"        "+javaNameStr+"Dao.delete("+javaNameStr+");\r\n"
				+"     }\r\n"
				+"}\r\n\n");
	return str.toString();
}
 ...
 * 2015年6月24日
 */
public static void createXml(String pagekagePathStr,String tableName,boolean flag) throws Exception{
 ...
 * 2015年6月24日
 */
public static String createXmlContent(String pagekagePathStr,ResultSetMetaData data,String tableName,boolean flag) throws SQLException, IOException{
	String javaName=getFileName(tableName);
	String javaNameStr=javaName.replaceFirst(javaName.substring(0, 1), javaName.substring(0, 1).toLowerCase());
	StringBuffer str=new StringBuffer("");
	String time="";
	...
	str.append("<mapper namespace=\""+pagekagePathStr+".dao."+javaName+"Dao\">\r\n");
	str.append("   <resultMap id=\"BaseResultMap\" type=\""+pagekagePathStr+".model."+javaName+"\">\r\n");
	for(int i = 1 ; i<= data.getColumnCount() ; i++){ 
		...
		if(columnName.contains("id")){
			id=columnName;
			idStr=columnNameStr;
			str.append("         <id column=\""+columnName+"\" property=\""+columnNameStr+"\" jdbcType=\""+columnClassName+"\" />\r\n");
		}else{
			str.append("         <result column=\""+columnName+"\" property=\""+columnNameStr+"\" jdbcType=\""+columnClassName+"\" />\r\n");
		}
	}
	...
	for(int i = 1 ; i<= data.getColumnCount() ; i++){ 
		...
		String columnNameStr=replaceUnderlineAndfirstToUpper(columnName,"_","");
		str.append("      <if test=\""+javaNameStr+"."+columnNameStr+"!=null and "+javaNameStr+"."+columnNameStr+"!='' \">\r\n");
		str.append("        and "+columnName+"=#{"+javaNameStr+"."+columnNameStr+"}\r\n"
		    	  +"      </if>\r\n");
	} 
	str.append("   </where>\r\n");
	str.append("   </sql>\r\n");
	...
	for(int i = 1 ; i<= data.getColumnCount() ; i++){ 
		...
		if(columnName.equals(idname)){
			idsql="      <if test=\""+javaNameStr+"."+columnNameStr+"!=null and "+javaNameStr+"."
					+columnNameStr+"!='' \">\r\n"+"        "+columnName+"=#{"+javaNameStr+"."+columnNameStr+"}\r\n"
                       +"      </if>\r\n";
			idsql+="      where "+idname+"=#{"+javaNameStr+"."+columnNameStr+"}\r\n";
		}else{
			str.append("      <if test=\""+javaNameStr+"."+columnNameStr+"!=null and "+javaNameStr+"."+columnNameStr+"!='' \">\r\n");
		    str.append("        "+columnName+"=#{"+javaNameStr+"."+columnNameStr+"},\r\n"
		    		   +"      </if>\r\n");
		}
	} 
	str.append(idsql);
	...
	str.append("      DELETE FROM "+tableName+" WHERE "+idname+"=#{"+javaNameStr+"."+idcolumnNameStr+"}\r\n");
	str.append("   </delete>\r\n\n");
	str.append("</mapper>");
	return str.toString();
}
 ...
 * 2015年6月23日
 */
public static void createService(String pagekagePathStr,String tableName,boolean flag) throws Exception{
	String javaName=getFileName(tableName);//表名
	String pagekageStr=pagekagePathStr.replace("/", ".");
	importStr="";
	importStr+="import "+ pagekageStr+".model."+javaName+";\r\nimport java.util.List;\r\nimport com.midai.miya.utils.PageUtil;\r\n\n";
...
public static String createSerivceContent(String javaName){
	...
	str.append("     List<"+javaName+"> findByConditions("+javaName+" "+javaNameStr+",PageUtil page);\r\n\n");
	str.append("     long findByConditionsCount"+"("+javaName+" "+javaNameStr+");\r\n\n");
 ...
 * 2015年6月23日
 */
public static void createDao(String pagekagePathStr,String tableName,boolean flag) throws Exception{
	String javaName=getFileName(tableName);
	String pagekageStr=pagekagePathStr.replace("/", ".");
	importStr="";
...
public static String createDaoContent(String javaName){
	...
	str.append("     List<"+javaName+"> findByConditions"+"(@Param(\""+javaNameStr+"\")"+javaName+" "+javaNameStr+",@Param(\"page\")PageUtil page);\r\n\n");
	str.append("     long findByConditionsCount"+"(@Param(\""+javaNameStr+"\")"+javaName+" "+javaNameStr+");\r\n\n");
	str.append("     void save(@Param(\""+javaNameStr+"\")"+javaName+" "+ javaNameStr+");\r\n\n");
	str.append("     void update(@Param(\""+javaNameStr+"\")"+javaName+" "+ javaNameStr+");\r\n\n");
	str.append("     void delete(@Param(\""+javaNameStr+"\")"+javaName+" "+ javaNameStr+");\r\n\n");
	str.append("}");
	return str.toString();
}
/**
 ...
 * 2015年6月23日
 */
public static void create(String pagekagePathStr,String tableName) throws SQLException, IOException{
	...
	File file=new File(path+"/"+pagekagePathStr+"/"+javaName+".java");
	if(!file.exists()){
		file.createNewFile();
	}
	byte bytes[]=new byte[2000];
	bytes=(pagekegeStr+importStr+fileContent).toString().getBytes("utf-8"); 
	  try {
...
/**
 * 传入myw_开头的表名，去掉下划线以前的，下划线之后首字母大写
 * 王梦圆
 * 2015年6月23日
 */
public static String getFileName(String tableName){
	String javaName=tableName.replace("myw_", "");
	javaName=javaName.replaceFirst(javaName.substring(0, 1),javaName.substring(0, 1).toUpperCase())  ; 
 ...
 * 2015年6月23日
 */
public static String createModel(StringBuffer str,ResultSetMetaData data,String tableName) throws SQLException{
	String javaName=getFileName(tableName);
	str.append("import java.io.Serializable;\r\n");
	str.append("public class "+javaName+" implements Serializable {\n\n");
	...
	for(int i = 1 ; i<= data.getColumnCount() ; i++){ 
		...
		String columnClassName=getColumnClassName(data.getColumnClassName(i));
		//获取某列对应的表名 
		str.append("    public "+columnClassName+" "+"get"+columnName.replaceFirst(columnName.substring(0, 1),
				columnName.substring(0, 1).toUpperCase())+"(){\n"+
			"        return "+columnName+";\n    }\n"+
		"    public void set"+columnName.replaceFirst(columnName.substring(0, 1),
				columnName.substring(0, 1).toUpperCase())+"("+columnClassName+" "+columnName+"){\n"
...
{  
   ...
   {  
    ...
    {  
     ...
     srcStr=srcStr.replaceFirst(srcStr.substring(0, 1),srcStr.substring(0, 1).toUpperCase()); 
    }  
   }  
